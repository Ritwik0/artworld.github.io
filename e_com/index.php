        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ml-auto">
              ...
              <li class="nav-item "><a class="nav nav-link" href="my_account.php">About</a></li>
  ...
  <section class="section section-one container-fluid">
          ...
          <div class="row">
              <div class="product_containe container row">
                  <div onclick="window.location.href='reg_user.html';" class="product_card col-12 col-lg-3 col-md-4">
                  ...
                  <div class="product_card col-12 col-lg-3 col-md-4">
